...
Public Class SetupForm
	...
	Private Sub btnInfo_Click(sender As Object, e As EventArgs) Handles btnInfo.Click
		...
		MessageBox.Show("This program allows you to set up & manage multiple shared folders on your local system." & vbCrLf & vbCrLf &
						...
						"to toggle All of your Shares ON Or OFF with a simple flip of a switch" & vbCrLf & vbCrLf &
						"NOTE: This program does not remove directories from your system, it just adjust thier attributes","Program Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
	End Sub
End Class
